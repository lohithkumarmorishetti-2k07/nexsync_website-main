  ...
  return (
    <div className={`cyber-event-card ${isFeatured || event.isFeatured ? "featured" : ""}`}>
            ...
            <img
              ...
              onError={(e) => {
                ...
                if (fallback && e.target.src !== fallback) {
                  ...
                  const wrap = e.target.closest('.event-cover-wrapper');
      ...
      <style>{`
        ...
        /* EVENT COVER SCALING & AMBIENT BACKDROP */
        .event-cover-wrapper {
          width: 100%;
          height: 165px;
          position: relative;
